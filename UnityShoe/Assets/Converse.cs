...
public class Converse : Shoe
{
    ...
    {
        Vector3 tl = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y + (collider.radius * gameObject.transform.localScale.y * 1.5f), gameObject.transform.position.z);
        Vector3 br = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z - (collider.radius * gameObject.transform.localScale.y * 1.25f));
        return new Tuple<Vector3, Vector3>(tl, br);
    }

    public Tuple<Vector3, Vector3> GetTopRightCoords(CapsuleCollider collider)
    {
        Vector3 tl = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y + (collider.radius * gameObject.transform.localScale.y * 2.15f), gameObject.transform.position.z);
        Vector3 br = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y - (collider.radius * gameObject.transform.localScale.y * 1f), gameObject.transform.position.z - (collider.radius * gameObject.transform.localScale.y * 1.25f));
        return new Tuple<Vector3, Vector3>(tl, br);
    }
