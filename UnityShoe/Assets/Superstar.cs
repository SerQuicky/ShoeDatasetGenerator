...
public class Superstar : IShoeInterface
{
    ...
    {
        Vector3 tl = new Vector3(ShoeType.transform.position.x + (collider.height * ShoeType.transform.localScale.x * 0.35f), ShoeType.transform.position.y + (collider.radius * ShoeType.transform.localScale.y * 2f), ShoeType.transform.position.z);
        Vector3 br = new Vector3(ShoeType.transform.position.x - (collider.height * ShoeType.transform.localScale.x * 0.65f), ShoeType.transform.position.y - (collider.radius * ShoeType.transform.localScale.y * 0.25f), ShoeType.transform.position.z);
